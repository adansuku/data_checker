...
RSpec.describe CardValidator::Visa do
  describe '.valid?' do
    context 'with a valid Visa card number' do
      it 'returns true' do
        expect(CardValidator::Visa.valid?('4111 1111 1111 1111')).to be(true)
      end
    end

    context 'with an invalid Visa card number' do
      it 'returns false' do
        expect(CardValidator::Visa.valid?('4111 1111 1111 1112')).to be(false)
      end
    end
